...
describe('extractPHP', () => {
  ...
  test('should extract the PHP tarball successfully', async () => {
  ...
  test('should throw an error if tarballPath is invalid', async () => {
  ...
  test('should throw an error if version is invalid', async () => {
  ...
  test('should throw an error if tarball does not exist', async () => {
  ...
  test('should throw an error if extraction fails', async () => {
    fs.existsSync.mockReturnValue(true);
    path.dirname.mockReturnValue(outputDir);
